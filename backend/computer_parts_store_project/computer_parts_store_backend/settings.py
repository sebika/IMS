"""
Django settings for computer_parts_store_backend project.
...
ROOT_URLCONF = 'computer_parts_store_backend.urls'
...
WSGI_APPLICATION = 'computer_parts_store_backend.wsgi.application'
...
AUTH_USER_MODEL = "computer_parts_store.CustomUser"
